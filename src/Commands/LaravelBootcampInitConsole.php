...
class LaravelBootcampInitConsole extends Command
{
    ...
    public function handle()
    {
        ...
        echo ''.__FILE__.'->'.__method__.'() line:'.__line__.PHP_EOL.'   $steps  = '.print_r($steps, true).PHP_EOL;
        $stepsResult = $this->parseSteps($steps);
        echo ''.__FILE__.'->'.__method__.'() line:'.__line__.PHP_EOL.'   $stepsResult  = '.print_r($stepsResult, true).PHP_EOL;
